...
$Notic=checkstr($_REQUEST["P_Notic"]);
...
$preEncodeStr=$Sparter.$SysOrderId.$OrderId.$CardId.$CardPass.$FaceValue.$PayMoney.$SubMoney.$ChannelId.$BankId.$Subject.$description.$Quantity.$Price.$Notic.$B_Result_Url.$B_Notify_Url.$ErrCode.$TimesTamp.$Suserkey;
