<?php
namespace umeng;
require_once(dirname(__FILE__) . '/' . 'upush/notification/android/AndroidBroadcast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/android/AndroidFilecast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/android/AndroidGroupcast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/android/AndroidUnicast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/android/AndroidCustomizedcast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/ios/IOSBroadcast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/ios/IOSFilecast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/ios/IOSGroupcast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/ios/IOSUnicast.php');
require_once(dirname(__FILE__) . '/' . 'upush/notification/ios/IOSCustomizedcast.php');
class UPush {
	...
	function sendAndroidUnicast($device_tokens,$ticker,$title,$text,$extra=[]) {
		try {
			...
			$unicast->setPredefinedKeyValue("custom",           json_encode($extra));
