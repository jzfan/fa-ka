...
class YiyunWxGzh extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YiyunWxGzh';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YiyunWxGzh';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YiyunWxGzh_notify_success',$order->trade_no);
                echo 'success';
            } else {
                echo 'fail';
            }
