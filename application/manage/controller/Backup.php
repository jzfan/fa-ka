...
class Backup extends BasicAdmin
{
    public $config = '';                                                        //相关配置
    public $model = '';                                                         //实例化一个model
    public $content;                                                            //内容
    public $dbName = '';                                                        //数据库名
    public $dir_sep = DS;                                                      //路径符号
    //初始化数据
