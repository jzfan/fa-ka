...
use think\Request;
use app\common\Pay;
class ShenduAliScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        $params = [
            ...
            'notify_url'   => Request::instance()->domain().'/pay/notify/ShenduAliScan',
            'payment_code' => '8004',
            'out_trade_no' => $outTradeNo,
            'total_fee'    => $totalAmount,
            'body'         => $subject,
            'return_url'   => Request::instance()->domain().'/pay/page/ShenduAliScan',
        ];
        ...
        if($response['state'] == 1) {
            $this->code    =0;
            $obj           =new \stdClass();
            $obj->pay_url  =$response['data']['qrcode_url'];
            $obj->content_type = 1;
            return $obj;
        } else {
            $this->code    =201;
