...
class NodeService
{
    ...
    public static function get($nodes = [])
    {
        ...
        $ignore = ['index', 'wechat/api', 'wechat/notify', 'wechat/review', 'admin/plugs', 'admin/login', 'admin/index', 'merchant','admin/auth/google', 'admin/auth/resetgoogle', 'admin/auth/sendsmscode'];
