...
class FnQqScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $response = $client->call('qq.unified', [
            ...
            'notify_url' => Request::instance()->domain().'/pay/notify/FnQqScan',
