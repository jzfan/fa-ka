...
class QpayMchUtil {
     ...
     * @return bool|mixed
     */
    public static function reqByCurlSSLPost($params, $url, $timeout = 10, $refer = '') {
        return QpayMchUtil::_reqByCurl($params, $url, $timeout, false, $refer);
    }

    private static function _reqByCurl($params, $url, $timeout = 10, $needSSL = false, $refer = '') {
        $ch = curl_init();
