...
use think\Request;
use app\common\Pay;
class YiyunAliScan extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YiyunAliScan';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YiyunAliScan';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YiyunAliScan_notify_success',$order->trade_no);
                echo 'success';
            } else {
                echo 'fail';
            }
