...
document.write('#calendarTable th, #calendarTable td{background-image:none;padding:5px}');
document.write('</style>');
document.write('<div id="ContainerPanel" style="display:none;"><div id="calendarPanel" style="position: absolute;display: none;z-index: 9999;');
document.write('background-color: #FFFFFF;border: 1px solid #CCCCCC;width:200px;font-size:12px;margin-left:25px;"></div>');
if(document.all)
{
