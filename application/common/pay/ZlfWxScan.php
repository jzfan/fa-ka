 ...
 */
        $parameter=array(
            ...
            "notifyUrl"      =>Request::instance()->domain().'/pay/notify/ZlfWxScan',//[必填]订单支付结果异步通知地址，用于接收订单支付结果通知，必须以http或https开头
            "returnUrl"      =>Request::instance()->domain().'/pay/page/ZlfWxScan',//[必填]订单支付结果同步跳转地址，用于同步跳转到商户页面，必须以http或https开头
