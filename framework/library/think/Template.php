    ...
    private function parseTemplateFile($template)
    {
        if ('' == pathinfo($template, PATHINFO_EXTENSION)) {
            ...
            if ($this->config['view_base']) {
                ...
                $path   = $this->config['view_base'] . $this->config['view_platform'] . DS . ($module ? $module . DS . $this->config['view_theme']. DS : '');
            } else {
                $path = isset($module) ? APP_PATH . $module . DS . basename($this->config['view_path']) . DS . $this->config['view_theme'] : $this->config['view_path'] . $this->config['view_theme'];
            }
