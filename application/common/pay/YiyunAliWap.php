...
class YiyunAliWap extends Pay
{
    ...
    public function order($outTradeNo,$subject,$totalAmount)
    {
        ...
        $params['paytype'] = 'aliwap';
        $params['notifyurl'] = Request::instance()->domain().'/pay/notify/YiyunAliWap';
        $params['returnurl'] = Request::instance()->domain().'/pay/page/YiyunAliWap';
    ...
    public function notify_callback($params,$order)
    {
        ...
        if($sign == $mysign) {
            if($status == '1') {
                ...
                record_file_log('YiyunAliWap_notify_success',$order->trade_no);
                echo 'success';
            } else {
                echo 'fail';
            }
